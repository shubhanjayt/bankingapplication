...
//            out.println(amount);
            ...
            try {
                ...
                pst.setInt(6, 0);
                pst.setInt(7, Integer.parseInt(amount) + lastbal);
                
                pst.executeUpdate();
                
                out.println("Connection done.. cash deposit in bank transaction table");
                ...
                pst2.setInt(6, 0);
                pst2.setInt(7, Integer.parseInt(amount) + lastbalcust);
                
                pst2.executeUpdate();
                
                out.println("Connection done.. cash deposit in customer table");
